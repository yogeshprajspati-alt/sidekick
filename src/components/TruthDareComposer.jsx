...
const PASS_KEY = 'sidekick_td_passes_used'
const DRAFT_KEY = 'sidekick_td_draft'
const ENABLED_KEY = 'sidekick_td_enabled'
const INTENSITY_KEY = 'sidekick_td_intensity'
const SAFEWORD_KEY = 'sidekick_td_safeword_until'
const CATEGORY_KEY = 'sidekick_td_category'
const MAX_PASSES = 3
